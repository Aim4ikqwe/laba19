public class Main {
    public static void main(String[] args) {
        ...
        clothing[0] = new Skirt(Size.S, 4444, "Красно-Бурмалиновый");
        clothing[1] = new Pants(Size.XXS, 76852, "Черный");
        clothing[2] = new TShirt(Size.L, 14923, "Морской волны");
        clothing[3] = new Tie(Size.XS, 148382, "Красный");
